namespace FortniteApi
{
    ...
    {
        public const string UserAgent = "game=UELauncher, engine=UE4, build=6.5.2-3690764+++Portal+Release-Live";

        public const string UserAgentFortnite = "game=Fortnite, engine=UE4, build=++Fortnite+Release-Cert-CL-3690881";
